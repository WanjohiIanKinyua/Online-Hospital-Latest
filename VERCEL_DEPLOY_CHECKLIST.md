...
# Optional for Jitsi as a Service:
# REACT_APP_JITSI_APP_ID=your-jaas-app-id
...
For production Jitsi embedding, replace `REACT_APP_JITSI_DOMAIN` with your Jitsi as a Service or self-hosted Jitsi domain. Public `meet.jit.si` embedding may show demo-use limits.
