...
function Consultation() {
  ...
  const copyHostedRoomLink = async () => {
    try {
      await navigator.clipboard.writeText(hostedRoomUrl);
      setConnectionMessage('Jitsi meeting link copied.');
    } catch (copyError) {
      setError('Could not copy the Jitsi meeting link. Open the room and copy it from the address bar.');
    }
  };
